...
- (int)create:(Schedule *)model {
    ...
    if ([self openDB]) {
        ...
        if (sqlite3_prepare_v2(db, [sqlStr UTF8String], -1, &statement, NULL) == SQLITE_OK) {
            ...
            sqlite3_bind_int(statement, 4, model.Events.EventID);
...
- (int)modify:(Schedule *)model {
    ...
    if ([self openDB]) {
        ...
        if (sqlite3_prepare_v2(db, [sqlStr UTF8String], -1, &statement, NULL) == SQLITE_OK) {
            ...
            sqlite3_bind_int(statement, 2, model.Events.EventID);
    ...
    if ([self openDB]) {
        ...
        if (sqlite3_prepare_v2(db, [qsql UTF8String], -1, &statement, NULL) == SQLITE_OK) {
            ...
            while (sqlite3_step(statement) == SQLITE_ROW) {
                ...
                schedule.Events.EventID = sqlite3_column_int(statement, 3);
